...
class MovieController extends AbstractController
{
    ...
    public function getMovie( int $idMovie ): Response
    {
      ...
      if ($idMovie>14){
        ...
        return new Response("Le film n°$idMovie n'existe pas",404);
    ...
    public function displayMovie (int $idMovie): Response
    {
        ...
        // On va directement chercher la case du tableau
        // en utilisant l'indice donné en paramètre
    ...
    public function getMovies (): Response
    {
        ...
        //$output = print_r( $this->_movies, true); 
